"""
Django settings for aquacycl_project project.
...
env = environ.Env()
environ.Env.read_env(os.path.join(f"{BASE_DIR}/aquacycl_project", ".env"))
...
ROOT_URLCONF = "aquacycl_project.urls"
...
WSGI_APPLICATION = "aquacycl_project.wsgi.application"
...
# Front end URL
FRONT_END_BASE_URL = constants.FRONT_END_BASE_URL[ENV]

# From Email
BASE_FROM_EMAIL = constants.BASE_FROM_EMAIL[ENV]
...
if ENV == "QA" or ENV == "STG" or ENV == "DEV" or ENV == "PROD":
...
if ENV == "LOCAL" or ENV == "DEV" or ENV == "QA":
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "aquacycl_project/static"),
]
...
CRONJOBS = [
    (
        "0 * * * *",
        "aquacycl_app.cronjobs.update_site_manifest_details",
        constants.LOG_PATH,
    ),
]
